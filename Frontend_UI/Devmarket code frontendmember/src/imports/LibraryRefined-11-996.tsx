import svgPaths from "./svg-jwm54fo20u";
...
function Paragraph() {
  return (
    <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold h-[49px] relative shrink-0 text-[#72fe8f] w-full" data-name="Paragraph">
      <div className="-translate-y-1/2 absolute flex flex-col h-[48px] justify-center left-0 opacity-90 text-[48px] top-[24px] w-[103.16px]">
